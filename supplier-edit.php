...
// ===== Tampil yang di edit
$id_pemasok = $_GET['edit_pemasok'];

$result = pg_query($db, "SELECT * FROM pemasok WHERE id_pemasok = $id_pemasok");
$edit_pemasok = pg_fetch_assoc($result);

// ===== Edit pemasok
if (isset($_POST['edit'])) {
    if (edit_pemasok($_POST)) {
        echo "
          <script> 
        ...
        <div class="main-content w-100">
            ...
            <div class="container main-content p-5">
                <div class="header p-4 pe-5 ps-5 shadow mb-4 w-50 bg-light rounded-3">
                    <h5 class="fw-bold mb-4">Edit Pemasok</h5>
                    <form action="" method="POST" enctype="multipart/form-data" class="w-100">
                        <input type="hidden" class="form-control" name="id_pemasok" value="<?= $edit_pemasok['id_pemasok'] ?>">
                        <div class="mb-3 row align-items-center">
                            <label for="nama" class="col-sm-3 col-form-label">Nama</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="nama" name="nama_pemasok" required value="<?= $edit_pemasok['nama_pemasok'] ?>">
                            </div>
                        </div>
                        <div class="mb-3 row align-items-center">
                            <label for="no_telp" class="col-sm-3 col-form-label">Telepon</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="no_telp" name="no_telp" required value="<?= $edit_pemasok['no_telp'] ?>">
                            </div>
                        </div>
                        <div class="mb-3 row align-items-center">
                            <label for="alamat" class="col-sm-3 col-form-label">Alamat</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="alamat" name="alamat" required value="<?= $edit_pemasok['alamat'] ?>">
                            </div>
                        </div>
